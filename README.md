...
### OHIF Медицинский Просмотрщик
![OHIF Viewer](docs/images/ohif-viewer.png)

### Врачебные Отчеты  
![Doctor Reports](docs/images/doctor-reports.png)

### Многоязычный Интерфейс
![Multilingual](docs/images/multilingual.png)
